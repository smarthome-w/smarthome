...
{
    String messageTopic = GLOBAL_MQTT_MESSAGE_PREFIX + "/" + GLOBAL_MQTT_MULTISENSOR_NAME + "_Position";
...
// name, pwtPin, manualUpPin, manualDownPin, upLimitPin, downLimitPin, messageTopic, messageValue, currentPWM
    ...
    servos[iix] = {"window", pinD2, pinD6, pinD7, pinD1, pinD5, "servoWindow", "", 0};
    iix++;
#endif
#ifdef BedroomRollershutter
    servos[iix] = {"window", pinD2, pinD7, pinD6, pinD5, pinD1, "servoWindow", "", 0};
    iix++;
#endif
